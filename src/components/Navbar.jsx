...
const Navbar = () => {
  const navLinks = [
    { name: "Home", path: "/hotel_booking/" },
    { name: "Hotels", path: "/hotel_booking/rooms" },
    { name: "Experience", path: "/hotel_booking/" },
    { name: "About", path: "/hotel_booking/" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-8">
        ...
        <button
          onClick={() => navigate("/hotel_booking/owner")}
          ...
          <UserButton>
            <UserButton.MenuItems>
              <UserButton.Action
                label="My Bookings"
                labelIcon={BookIcon}
                onClick={() => navigate("/hotel_booking/my-bookings")}
              />
            </UserButton.MenuItems>
          </UserButton>
        ) : (
