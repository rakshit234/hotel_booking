      ...
      <div className="py-28 md:py-36 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            {room?.images.length > 1 &&
              room.images.map((image, index) => (
                <img
                  ...
                  src={image}
                  alt="Room Image"
                  className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && "ring-3 ring-orange-500"}`}
                />
              ))}
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          <div>
            ...
            <div className="flex flex-wrap gap-3 mt-4 max-w-xl">
